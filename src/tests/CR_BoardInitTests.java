...
public class CR_BoardInitTests {
	...
	public void testRoomInitials() {
		assertEquals('C', board.getRoomCellAt(0, 0).getCellData());
		assertEquals('R', board.getRoomCellAt(4, 8).getCellData());
		assertEquals('B', board.getRoomCellAt(9, 0).getCellData());
		assertEquals('O', board.getRoomCellAt(21, 22).getCellData());
		assertEquals('K', board.getRoomCellAt(21, 0).getCellData());
	}
