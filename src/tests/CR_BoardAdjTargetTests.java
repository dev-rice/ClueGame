...
public class CR_BoardAdjTargetTests {
	...
	{
		// Test a corner
		LinkedList<Integer> testList = board.getAdjacencies(board.calcIndex(0, 0));
		Assert.assertEquals(0, testList.size());
		// Test one that has walkway underneath
		testList = board.getAdjacencies(board.calcIndex(4, 0));
		Assert.assertEquals(0, testList.size());
		// Test one that has walkway above
		testList = board.getAdjacencies(board.calcIndex(15, 20));
		Assert.assertEquals(0, testList.size());
		// Test one that is in middle of room
		testList = board.getAdjacencies(board.calcIndex(18, 11));
		Assert.assertEquals(0, testList.size());
		// Test one beside a door
		testList = board.getAdjacencies(board.calcIndex(14, 12));
		Assert.assertEquals(0, testList.size());
		// Test one in a corner of room
		testList = board.getAdjacencies(board.calcIndex(5, 20));
		Assert.assertEquals(0, testList.size());
	}
	...
	{
		// TEST DOORWAY RIGHT 
		LinkedList<Integer> testList = board.getAdjacencies(board.calcIndex(11, 6));
		Assert.assertEquals(1, testList.size());
		Assert.assertTrue(testList.contains(board.calcIndex(11, 7)));
		// TEST DOORWAY LEFT 
		testList = board.getAdjacencies(board.calcIndex(10, 17));
		Assert.assertEquals(1, testList.size());
		Assert.assertTrue(testList.contains(board.calcIndex(10, 16)));
		//TEST DOORWAY DOWN
		testList = board.getAdjacencies(board.calcIndex(5, 15));
		Assert.assertEquals(1, testList.size());
	...
	public void testAdjacencyDoorways()
	{
		...
		LinkedList<Integer> testList = board.getAdjacencies(board.calcIndex(4, 4));
		...
		testList = board.getAdjacencies(board.calcIndex(6, 15));
		...
		testList = board.getAdjacencies(board.calcIndex(15, 17));
		...
		testList = board.getAdjacencies(board.calcIndex(13, 11));
		...
		testList = board.getAdjacencies(board.calcIndex(5, 3));
	...
	public void testAdjacencyWalkways()
	{
		...
		LinkedList<Integer> testList = board.getAdjacencies(board.calcIndex(0, 4));
		Assert.assertTrue(testList.contains(5));
		Assert.assertEquals(1, testList.size());
		
		// Test on left edge of board, three walkway pieces
		testList = board.getAdjacencies(board.calcIndex(6, 0));
		...
		testList = board.getAdjacencies(board.calcIndex(6, 21));
		...
		testList = board.getAdjacencies(board.calcIndex(15,7));
		...
		testList = board.getAdjacencies(board.calcIndex(21, 15));
		...
		testList = board.getAdjacencies(board.calcIndex(14, 22));
